...
import com.example.profilingserver.model.CpuLoadData;
import com.example.profilingserver.model.HeapSummaryData;
...
//                    CpuMachineTotal.add((Float)event.getValue("machineTotal")*100F);
        ...
        return new ResponseData(heapSummaryDataList,cpuLoadDataList);
    }
}
